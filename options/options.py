...
class Options():
    ...
    def initialize(self):
        self.parser.add_argument('--datarootA', required=True, help='path to images trainA')
        self.parser.add_argument('--datarootB', required=False, default='NoB', help='path to images trainB')
        self.parser.add_argument('--imageSize', type=int, default=224, help='then crop to this size')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--tau', type=float, default=0.05, help='threshold for distinguish between low and high response in a normalized feature.')
        self.parser.add_argument('--alpha_th', type=float, default=1.0, help='threshold blending using distance map, should be between 0 to 1.')
        self.parser.add_argument('--isolation_th', type=float, default=1.0, help='eliminating correspoinding points under this threshold in the density.')
        self.parser.add_argument('--border_size', type=int, default=7, help='removing this brder_size correspondences at the final mapping')
        ...
        self.parser.add_argument('--results_dir', type=str, default='./reults', help='models are saved here')
